<template>
    ...
    <div class="row">
        ...
        <message_list :messagesList="messagesList" :type="'send'"></message_list>
    </div>
    </div>
    <div v-else>
        جارى التحميل ........
...
<script>
    ...
    export default {
        ...
        mounted:function () {
         this.getSendMessagesByUser();
        },
        methods:{
            getSendMessagesByUser: function () {
                this.$http.get('/getSendMessagesByUser').then(function(res){
