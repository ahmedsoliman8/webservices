                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                          ...
                          <li>
                            <a class="pull-left" href="{{url('/adminpanel/changeStatus/'.$buWaiting->id.'/1')}}">
                              <span>تفعيل العقار</span>
                            </a>
                            <a class="pull-right" href="{{url('/adminpanel/bu/'.$buWaiting->id.'/edit')}}">
                              <span>{{$buWaiting->bu_name}}</span>
                            </a>
                  ...
                  <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <!-- inner menu: contains the actual data -->
                        <ul class="menu">
                          @foreach(unreadMessage() as $keymessages => $valuemessages )
                          <li><!-- Task item -->
                            <a href="{{url('/adminpanel/contact/'.$valuemessages->id.'/edit')}}">
                              <h3>
                                {{$valuemessages->contact_name}}
                                <small class="pull-right">{{$valuemessages->created_at}}</small>
                              </h3>
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="{{url('/adminpanel/users/'.Auth::user()->id.'/edit')}}" class="btn btn-default btn-flat">ملفى الشخصى</a>
                        </div>
          ...
          <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <ul class="sidebar-menu">
                اخر زيارة بتاريخ 
                <li class="header">{{Auth::user()->updated_at}}</li>
